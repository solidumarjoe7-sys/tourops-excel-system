...
export default function ArrivalTable({
  ...
  // Start editing cell
  const handleCellClick = (id: string, field: keyof ArrivalRecord, value: any) => {
                ...
                <table className="w-full text-left border-collapse border border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                  <thead>
                    ...
                    <tr className="bg-[#FFFF00] text-black font-sans text-[10px] uppercase font-bold tracking-wider border-b border-black select-none">
                      ...
                      <th className="py-2 px-3 border-r border-black font-black text-black min-w-[140px] text-center">{t.colCollect}</th>
                    ...
                    {groupRecords.map((row) => {
                      return (
                        ...
                        >
                          ...
                          {/* AVAIL CELL */}
                          <td className="p-2 border-r border-black align-middle font-bold text-emerald-900">
                            {editingCell?.id === row.id && editingCell?.field === "avail" ? (
                              ...
                              <div
                                ...
                                className="py-1 px-1.5 hover:bg-amber-100 transition-colors cursor-pointer text-emerald-800 font-bold uppercase"
                          ...
                          <td className="p-2 border-r border-black align-middle font-black text-amber-900 font-mono">
                            {editingCell?.id === row.id && editingCell?.field === "eta" ? (
                              ...
                              <div
                                onClick={() => handleCellClick(row.id, "eta", row.eta)}
                                className="py-1 px-1.5 hover:bg-amber-100 transition-colors cursor-pointer font-black text-amber-800 font-mono uppercase"
                                title={t.clickToEditETA}
                              >
                          ...
                          {/* COLLECT CELL */}
                          <td className="p-2 border-r border-black align-middle font-black text-rose-800 font-mono uppercase">
                            {editingCell?.id === row.id && editingCell?.field === "collect" ? (
                              ...
                              <div
                                onClick={() => handleCellClick(row.id, "collect", row.collect)}
                                className="py-1 px-1.5 hover:bg-amber-100 transition-colors cursor-pointer font-black text-rose-800 uppercase"
                                title={t.clickToEditCollect}
                              >
