                            ...
                            (() => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`p-1 px-1.5 border ${borderClass} rounded-none ${bgClass} hover:bg-[#F2EDD5] hover:shadow-[1.5px_1.5px_0px_0px_rgba(0,0,0,1)] cursor-pointer text-[10px] space-y-1 transition-all select-none`}
                                  title="I-click para baguhin ang duty log"
                                >
                                  {isDayOff ? (
